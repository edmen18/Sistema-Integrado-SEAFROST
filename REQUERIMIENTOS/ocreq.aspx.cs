...
public partial class ocreq : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs args)
    {
        if (!this.IsPostBack)
        {
            ...
            ddlalma.DataBind();
            ddlalma.Items.Insert(0, new ListItem("ALMACEN DE MANTENIMIENTO", "0006"));


            //ddlFormaPago.DataTextField = "TG_DESCRI";
            //ddlFormaPago.DataValueField = "TG_CODIGO";
            //ddlFormaPago.DataSource = CP0003TAGE.C_ListarTablaGePorCodigo("51");
            //ddlFormaPago.DataBind();
            //ddlFormaPago.Items.Insert(0, new ListItem("CONTADO", "-1"));
    ...
    protected void btnFinalizar_Click(object sender, EventArgs e)
    {
        ...
        for (int y = 0; y <= GridView1.Rows.Count - 1; y++)
        {
            ...
            for (int s = inicio; s <= cuenta + inicio - 1; s++)
            {
                ...
                fila.OC_CSOLICT= GridView1.Rows[y].Cells[1].Text;
                lista.Add(fila);
            }
        ...
        foreach (var muestra in prov)
        {
            ...
            {
                AC_CVANEXO = "P",
                AC_CCODIGO = muestra.OC_CCODPRO.Trim()
            };
          
            var fpg = CP0003MAES.listarMaestroxunID(ADATA)==null ? string.Empty : CP0003MAES.listarMaestroxunID(ADATA).AC_CFORPA1;
            CP0003TAGE TG = new CP0003TAGE()
            {
                TG_INDICE = "51",
                TG_CODIGO = fpg.Trim()
            };

            var fpg1 = CP0003TAGE.ListarTGID(TG)==null ? string.Empty : CP0003TAGE.ListarTGID(TG).TG_DESCRI ;
            ...
            CABC.OC_CFORPA1 = fpg1.Trim();//ddlFormaPago.SelectedItem.Text;
            ...
            CABC.OC_CDETENT = ((txtObservacion.Text.Length > 80) ? txtObservacion.Text.Substring(0, 79) : txtObservacion.Text);
            CABC.OC_CSITORD = "1";
            ...
            CABC.OC_CCONDIC = "31";// string.Empty;
            ...
            foreach (var det in detalle)
            {
                ...
                CABC.OC_CSOLICT = det.OC_CSOLICT;
                ...
                DETA.OC_NTOTUS = det.OC_CCODMON.Trim()=="US" ? OC_NTOTMN :(OC_NTOTMN / det.OC_NTIPCAM);
                DETA.OC_NTOTMN = det.OC_CCODMON.Trim() == "MN" ? OC_NTOTMN : (OC_NTOTMN / det.OC_NTIPCAM); ;
    ...
    {
        txtProveedor.Text = CT0003ANEX.obtenProveedor(txtruc.Text)==null ? string.Empty : CT0003ANEX.obtenProveedor(txtruc.Text).ADESANE;
        hfproveedor.Value = txtruc.Text;
