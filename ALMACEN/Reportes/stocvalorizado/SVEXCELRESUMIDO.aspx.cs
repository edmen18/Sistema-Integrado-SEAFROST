...
public partial class ALMACEN_REPORTES_stocvalorizado_SVEXCELRESUMIDO : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        worksheet.Range("C4:J4").Row(1).Merge();
            ...
            detalle = AL0003ALMA.RptSVRESUMIDO(TABL,"A");
            ...
            foreach (AL0003ARTI a in LISTART)
        {
            ...
            worksheet.Cell("C" + (contdetalle + 1).ToString()).Value = "Total";
        ...
        Response.AddHeader("content-disposition", "attachment;filename=\"Stock_Valorizado_Resumido.xlsx\"");
        ...
        if (indicador != "TAR")
        {
            ...
            detalle = AL0003ALMA.RptSVRESUMIDO(TABL,codigo);
