...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:HiddenField runat="server" ID="hfusu" />
        <div id="contenedor">
        <fieldset>
            <legend>ENTRADAS Y SALIDAS VALORIZADAS</legend>
            ...
            <table>
                ...
                <tr>
                    <td>
                        <asp:RadioButtonList ID="rbmovi" runat="server" RepeatDirection="Horizontal" Width="449px" OnSelectedIndexChanged="rbmovi_SelectedIndexChanged" AutoPostBack="true" >
                            <asp:ListItem Text="Entradas" Value="E" Selected="True"></asp:ListItem>
                            <asp:ListItem Text="Salidas" Value="S"></asp:ListItem>
                ...
                <tr>
                    <td>
                        <div id="dvmov" style="overflow: auto; width: 500px; height: 200px">
                          <asp:GridView ID="gvmovi" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"  AutoGenerateColumns="False" Width="409px">
                                     <Columns>
                                         <asp:BoundField DataField="TM_CCODMOV" HeaderText="CODIGO" ItemStyle-Width="8" />
                                         <asp:BoundField DataField="TM_CDESCRI" HeaderText="MOVIMIENTO"  ItemStyle-Width="300"  />
            ...
            <table>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:TextBox runat="server" ID="txtfecha1" Width="130" MaxLength="10" placeholder="DD/MM/AAAA" />
                    </td>
                    
                    </tr><tr>
                    <td>Al Mes:</td>
                    <td>
                        <asp:TextBox ID="txtfecha2" runat="server" Width="130" placeholder="DD/MM/AAAA" ></asp:TextBox>
                    </td>
                </tr>
                <tr><td>Consumo en:</td>
                    <td >
                ...
                <tr>
                    ...
                    <td >
                         <asp:Button class="btn" Text="Aceptar" runat="server" ID="btacepta" UseSubmitBehavior="false" OnClick="btacepta_Click" Enabled="true"></asp:Button>
                    </td>
                </tr>
                </table>
        </fieldset>
