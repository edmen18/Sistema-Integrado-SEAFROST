...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            Operacion.mask('txtTM').change(function () {
                cargar();
            });
            ...
            $('#btnNuevo').click(function () {
                ...
                window.open('../ALMACEN/RegistroEntrada.aspx', '_blank');
            });
            $('#btnSalida').click(function () {
                //window.location.href = '../ALMACEN/RegistroSalida.aspx';
                window.open('../ALMACEN/RegistroSalida.aspx', '_blank');
            });
            ...
            $('.btPrinter').live("click", function () {
                ...
                var AL = Operacion.mask('ddlMalmacen').val();
                var ND = $(this).parents("tr").find("td").eq(1).html();
                var PRO = $(this).parents("tr").find("td").eq(4).html();
                var PE = (TD == "PE" ? "E" : "S");

                if (AL == "0001" || AL == "0016" || AL == "0017" || AL == "0018") {
                    window.open("../ALMACEN/Reportes/ReporteFinaliza.aspx?AL=" + AL + "&TD=" + TD + "&ND=" + ND, '_blank');
                } else {
                    if (confirm('Desea agrupar la guia x producto')) {
                        window.open("../ALMACEN/Reportes/ReporteA.aspx?AL=" + AL + "&TD=" + TD + "&ND=" + ND + "&PR=" + PRO, '_blank');
                    } else {
            ...
            $('.btDetalle').live("click", function () {
                ...
                Operacion.mask('lbldOC').text(APE[ND][0]);
                Operacion.mask('lbldDocr').text(TD + "-" + DR);
                Operacion.mask('lbldCliente').text(CL + " " + DCL);
                Operacion.mask('lbldRuc').text(APE[ND][1] + " " + APE[ND][2]);
                        ...
                        if (data.d.length > 0) {
                            ...
                            for (var i = 0; i < data.d.length; i++) {
                                ...
                                $("#MainContent_gvDetalle").append("<tr><td style='font-size:8pt;text-align:center'>" +
                                    ...
                                    (data.d[i].C6_NPREUN1).toFixed(2) + "</td><td style='font-size:8pt;text-align:right'>" +
                                    (data.d[i].C6_NDESCTO).toFixed(2) + "</td><td style='font-size:8pt;text-align:right'>" +
                                    (data.d[i].C6_NPREUNI).toFixed(2) + "</td><td style='font-size:8pt;text-align:right'>" +
                                    parseFloat((data.d[i].C6_NCANTID) * (data.d[i].C6_NPREUN1)).toFixed(2) + "</td></tr>");
                                //data.d[i].C6_NUSPRUN + "</td></tr>");
                                sum += data.d[i].C6_NCANTID;
                            }
            ...
            function cargar() {
                llenarGrilla(Operacion.mask('ddlMalmacen').val(), Operacion.mask('ddlTipodocumento').val(), fecha1, fecha2, Operacion.mask('txtMNumeroDoc').val(), Operacion.mask('txtcodCliente').val(), Operacion.mask('txtTM').val());
            }
            var aa = 1;

            function llenarGrilla(AL, TD, FEC1, FEC2, ND, CCLI, TM) {
                ...
                var DATA = {};
                DATA.C5_CALMA = AL;
                DATA.C5_CTD = (TD == "-1" ? null : TD);
                DATA.C5_CNUMDOC = ND;
                DATA.C5_CCODMOV = TM;//NUEVO
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.d.length > 0) {
                            ...
                            for (var i = 0; i < data.d.length; i++) {
                                APE[data.d[i].C5_CNUMDOC] = [
                                    data.d[i].C5_CNUMORD,
                                    data.d[i].C5_CCODPRO,
                                    data.d[i].C5_CNOMPRO
                                ];
                                var fecha = data.d[i].C5_DFECDOC;//moment(data.d[i].C5_DFECDOC).format('DD/MM/YYYY');
                                var G1 = data.d[i].C5_CGLOSA1.trim();
                                //console.log(G1);
                                /*var oemb = (data.d[i].C5_CCODMOV == "MP" || data.d[i].C5_CCODMOV == "CO" && data.d[i].C5_CGLOSA1 != "" && (G1.length > 11) ? data.d[i].C5_CGLOSA1 :
                                        (data.d[i].C5_CCODMOV == "MP" || data.d[i].C5_CCODMOV == "CO" && data.d[i].C5_CGLOSA1 != "" && (G1.length == 10 || G1.length==11) ? obtieneEmbaracion(G1).oe : data.d[i].C5_CGLOSA1));*/
                                $("#MainContent_gvCRD").append("<tr><td style='font-size:8pt;text-align:center;'>" +
                                    ...
                                    //"</td><td style='width:100px;'><div class='btEditar' style='text-align:center;float:left;'><img alt='' src='../Images/edicion02.png' width='25' style='cursor:pointer'> </div><div class='btDetalle' style='text-align:center'><img alt='' src='../Images/Detalle.png' width='25' style='cursor:pointer;float:left;'> </div><div class='btPrinter' style='text-align:center'><img alt='' src='../Images/Printer.png' width='25' style='cursor:pointer;float:left;'> </div></td></tr>");
                                    G1 + "</td><td style='width:100px;'><div class='btEditar' style='text-align:center;float:left;'><img alt='' src='../Images/edicion02.png' width='25' style='cursor:pointer'> </div><div class='btDetalle' style='text-align:center'><img alt='' src='../Images/Detalle.png' width='25' style='cursor:pointer;float:left;'> </div><div class='btPrinter' style='text-align:center'><img alt='' src='../Images/Printer.png' width='25' style='cursor:pointer;float:left;'> </div></td></tr>");
                            }
                        } else {
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
        ...
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="auto-style2" colspan="3">Tipo Movimiento&nbsp;<asp:TextBox ID="txtTM" runat="server"></asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td class="auto-style2" colspan="3">Codigo Cliente&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtcodCliente" runat="server"></asp:TextBox>
                    </td>
                    <td class="auto-style3">&nbsp;</td>
                    <td colspan="2">
                        <asp:Label ID="lblCliente" runat="server" Text="Nombre cliente"></asp:Label>
                    </td>
                    <td colspan="2">
                ...
                <tr>
                    ...
                    <td class="auto-style1" colspan="10">
                        ...
                        <input id="btnNuevo" class="btn" type="button" value="Ingreso" />
                        <input id="btnSalida" class="btn" type="button" value="Salida" /></td>
                </tr>
                <tr>
                    <td colspan="13">
    ...
    <div id="detalle" title="Detalle" style="display: none;">
        <table style="width: 100%;">
            ...
            <tr>
                <td colspan="2">Nro. Doc Refencia</td>
                <td>
            ...
            <tr>
                <td colspan="2">Nro. Orden Compra</td>
                <td>
            ...
            <tr>
                <td colspan="2">Codigo Movimiento</td>
                <td>
            ...
            <tr>
                ...
                <td style="border: 1px solid #808080">
                    <asp:Label ID="lblCKG" runat="server" Text=""></asp:Label>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
