...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="TipoAnalisis.aspx.cs" Inherits="Default2" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#MainContent_TXTANALISIS").autocomplete(
                 {
                     source: function (request, response) {
                         $.ajax({
                             url: "TipoAnalisis.aspx/GETDATOS",
                             ...
                             success: function (data) {
                                 response($.map(data.d, function (item) {
                                     return {
                                         value: item.TA_CODIGO +"-"+ item.TA_DESCRIPCION,
                                         id: item.TA_CODIGO,
            ...
            $(".btdelete").click(function () { //  se debe colocar dentrp de una funcion 
                ...
                trp = $(this).parent().parent();
                id = $("td:eq(1)", trp).html();
                DETA.TA_DESCRIPCION = id;
                DETA.TA_ESTADO = 0;



                if ((DETA.TA_CODIGO == "") || (DETA.TA_DESCRIPCION == "")) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "TipoAnalisis.aspx/ActualizaAnticipo",
            ...
            function InsertarSolicitud() {
                ...
                var DETA = {};
                DETA.TA_DESCRIPCION = $("#MainContent_txtdescripcion").val();
                DETA.TA_CODIGO = $("#MainContent_lblcodigo").html();
                DETA.TA_ESTADO = 1;
                ...
                if ((DETA.TA_CODIGO == "") || (DETA.TA_DESCRIPCION == ""))
                {
                    ...
                    if ($("#MainContent_txtindicador").val() == "G") {
                        $.ajax({
                            ...
                            type: "POST",
                            url: "TipoAnalisis.aspx/InsertaDet",
                            data: '{DETA: ' + JSON.stringify(DETA) + '}',
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            async: false,
            ...
            function filtarsolicitudesParametro() {
                var VC = {};
                VC.TA_CODIGO = $("#MainContent_TXTIDANALISIS").val();
                alert(VC.TA_CODIGO);

                $.ajax({

                    type: "POST",
                    url: "TipoAnalisis.aspx/LISTARDATOSPARAM",
                    ...
                    success: function (data) {
                        ...
                        if (data.d.length > 0) {
                            ...
                            for (var i = 0; i < data.d.length; i++) {
                                $("td", row).eq(0).html(data.d[i].TA_CODIGO);
                                $("td", row).eq(1).html(data.d[i].TA_DESCRIPCION);
            ...
            function filtarsolicitudes() {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: "TipoAnalisis.aspx/LISTARDATOS",
                    data: '',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (data) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <fieldset style="background-color: #99CCFF">
        <legend style="font-weight: bold; background-color: #99CCFF;">
            <asp:Label ID="Label9" runat="server" Text="LISTADO DE TIPOS DE ANÁLISIS" Font-Bold="True" Font-Size="12pt"></asp:Label></legend>
        ...
        <tr>
            <td>
                <asp:GridView ID="gvordencompra" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" AutoGenerateColumns="False">
                    <Columns>
                        <asp:BoundField DataField="TA_CODIGO" HeaderText="CÓDIGO" />
                        <asp:BoundField DataField="TA_DESCRIPCION" HeaderText="DESCRIPCION" />
