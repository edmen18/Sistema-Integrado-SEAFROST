...
public partial class ReporteCabeceraBitacora : System.Web.UI.Page
{
    ...
    protected void btbusca_Click(object sender, EventArgs e)
    {
        ...
        gvsolicitudes.DataSource = tabla_transporte_cabViaje.reporteBitacora(fechaini, fechafin);// tabla_transporte_cabViaje.ListaTransporteCabecera();
