<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ReporteCabeceraBitacora.aspx.cs" Inherits="ReporteCabeceraBitacora" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="contenedor" style="float: left; width: 1000px">
        <fieldset style="float: left; width: 900px">
            <legend>REPORTE DE BITACORAS</legend>
                        ...
                        <div id="expo">
                            <asp:GridView ID="gvsolicitudes" class="filtrar" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" Width="958px" AutoGenerateColumns="False" >
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="detalle_pasajero" HeaderText="detalle_pasajero" />
                                    <asp:BoundField DataField="detalle_ccosto" HeaderText="detalle_ccosto" />
                                    <asp:BoundField DataField="detalle_labor" HeaderText="detalle_labor" />
                                
                                    <asp:BoundField DataField="procedencia" HeaderText="procedencia" />
                                    <asp:BoundField DataField="paradero" HeaderText="paradero" />
