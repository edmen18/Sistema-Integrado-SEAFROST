...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <link type="text/css" href="../CSS/Base-s.css?2.2" rel="stylesheet" />
    ...
    <script type="text/javascript">
        ...
        $(window).load(function () {
            ...
            var iniciaTITA = function (KEY) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.d.length > 0) {
                            Operacion.mask('txtDTASA').val(data.d[0].TDESCRI.substring(0, 25));
            ...
            $(".idart").autocomplete(
                          {
                              ...
                              select: function (event, ui) {
                                  ...
                                  $('#MainContent_txttar').val(Number(precioc).toFixed(4));
                                  $("#MainContent_csigv").val(strigv);
            ...
            $('#MainContent_txtCTASA').change(function () {
                iniciaTITA($(this).val());
            });
        });
    </script>
        ...
        <asp:MenuItem ImageUrl="~/Images/item-pointer.gif" 
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Codigo Tasa&nbsp;</td>
                    <td>
                        <asp:TextBox ID="txtCTASA" placeholder="XXXX" Enabled="false" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>Tipo Tarifa:</td>
                    ...
                    <td>Descricion</td>
                    <td>
                        <asp:TextBox ID="txtDTASA" Enabled="false" runat="server" Width="249px"></asp:TextBox>
                    </td>
                </tr>
                <%--<tr>
                    <td>Tipo:</td>
                ...
                <tr>
                    ...
                    <td>Monto Tasa</td>
                    <td>
                        <asp:Label ID="lblMTASA" placeholder="0.00" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>IGV:</td>
                    <td>
                        <asp:DropDownList runat="server" ID="csigv" Width="120"></asp:DropDownList>
                    </td>
                    <td>Porcentaje Tasa</td>
                    <td>
                        <asp:Label ID="lblPTASA" placeholder="0.00" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
