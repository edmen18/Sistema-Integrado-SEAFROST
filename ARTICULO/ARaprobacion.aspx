...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
        ...
        $(window).load(function () {
            ...
            var filtro = function () {
                ...
                $("#MainContent_txtfiltra").keyup(function () {
                    ...
                    $(".filtrar tr").show();
                    $.each(s, function () {
                        $(".filtrar tr:visible .producto:not(:contains('" + this + "'))").parent().hide() && $(".filtrar tr:visible .proveed:not(:contains('" + $('#MainContent_txtfiltra0').val().toUpperCase() + "'))").parent().hide();
                    });
                });
            }
            ...
            var filtro2 = function () {
                ...
                $("#MainContent_txtfiltra0").keyup(function () {
                    ...
                    $(".filtrar tr").show();
                    $.each(s, function () {
                        $(".filtrar tr:visible .proveed:not(:contains('" + this + "'))").parent().hide() && $(".filtrar tr:visible .producto:not(:contains('" + $('#MainContent_txtfiltra').val().toUpperCase() + "'))").parent().hide();
                    });
        ...
        $(function () {
            ...
            $('#dvaprobaciones').dialog({
                ...
                open: function (event, ui) {
                    Listausuarioproducto(idproductogenal, 1);
                },
                close: function (event, ui) {
                },
            }
    ...
    <script type="text/javascript">
        ...
        function Listausuarioproducto(idproducto, tcod) {

            $.ajax({
                type: "POST",
                url: "ARaprobacion.aspx/listarusuariosaproba",
                data: "{idproducto: '" + idproducto + "',tcod='" + tcod + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
                success: function (data) {
                ...
                success: function (data) {
                    if (data.d.length > 0) {
                        ...
                        for (var i = 0; i < data.d.length; i++) {
                            ...
                            $("td", row).eq(1).html(fech);
                            var precion = data.d[i].OC_NPREUN2;
                            $("td", row).eq(2).html(Number(precion).toFixed(4));
                            $("td", row).eq(3).html(data.d[i].OC_CNUMORD);
                            $("td", row).eq(4).html(data.d[i].OC_CCOMENTA);
        ...
        function VerificaInfodeunArti(idarticulo) {
            var AR_CCUENTA = "",AR_CPARARA = "",AR_CFORSER="";
            $.ajax({
                type: "POST",
            ...
            return { AR_CCUENTA, AR_CPARARA, AR_CFORSER };
        }
        ...
        $(function () {
            var iniciaTITA = function (KEY) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.d.length > 0) {
                            Operacion.mask('txtBTASA').val(KEY);
                            Operacion.mask('txtBDTASA').val(data.d[0].TDESCRI.substring(0,35));
                            var descri = data.d[0].TDESCRI.split("  ");
                            auxiliar = $.grep(descri, function (n) {
                                return (n);
                            });
                            //console.log(auxiliar);
                            Operacion.mask('lblMTASA').text(auxiliar[1]);
                            Operacion.mask('lblPTASA').text(auxiliar[2]);
                        } else {
                            alert('El codigo no se encuentra registrado');
                            Operacion.mask('txtBTASA').val('');
                            Operacion.mask('txtBDTASA').val('');
                            Operacion.mask('lblMTASA').text('');
                            Operacion.mask('lblPTASA').text('');
                        }
                    }, error: function (response) {
                        console.table(response);
                    }
            ...
            $(".btasig").click(function () {
                ...
                } else if ($("#MainContent_txtBTASA").val() == "" && $("#MainContent_txtBDTASA")=="") {
                    alert("No ha consignado la tasa referencial");
                    $(".clcuenta").focus();
                } else {
            ...
            $('#MainContent_txtBTASA').change(function () {
                $(this).numeric();
                iniciaTITA($(this).val());
            });
        });
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
        ...
        <fieldset style="float: left; width: 900px">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList runat="server" ID="ddlnegocio" Width="230" AutoPostBack="true"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td>Area:
                    ...
                    <td>
                        <asp:DropDownList runat="server" ID="ddlarea" Width="230" AutoPostBack="true" OnSelectedIndexChanged="ddlfilt_SelectedIndexChanged"></asp:DropDownList>
                    </td>
                </tr>
            </table>
            <table>
                ...
                <tr>
                    <td colspan="4">
                        <div id="expo">
                            <asp:GridView ID="gvproductos" class="filtrar" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" AutoGenerateColumns="False" Width="958px">
                                <Columns>
                                    <asp:BoundField DataField="AR_CCODIGO" HeaderText="ID" ItemStyle-Width="100">
                                        <ItemStyle CssClass="id"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="AR_CDESCRI" HeaderText="DESCRIPCION" ItemStyle-Width="350">
                                    ...
                                    <asp:BoundField DataField="AR_CCONTRO" HeaderText="ESTADO" ItemStyle-Width="100" ItemStyle-HorizontalAlign="center" />
                                    <asp:BoundField DataField="AR_CUSUCRE" HeaderText="USUARIO" ItemStyle-Width="100" ItemStyle-HorizontalAlign="center" />
    ...
    <div id="dvasiento" style="display:none;">
        <table>
            <tr>
                <td colspan="4">Cuenta Contable</td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td class="auto-style1">
                    <asp:TextBox ID="txtBTASA" class="cltasa" runat="server" Width="100px"></asp:TextBox>
                </td>
                <td class="auto-style1" colspan="3">
                    <asp:TextBox ID="txtBDTASA" class="cltasad" runat="server" Width="300px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style1">Monto Tasa</td>
                <td class="auto-style1">
                    <asp:Label ID="lblMTASA" runat="server" Text=""></asp:Label>
                </td>
                <td class="auto-style1">Porcentaje Tasa</td>
                <td class="auto-style1">
                    <asp:Label ID="lblPTASA" runat="server" Text=""></asp:Label>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3">
                    <asp:GridView ID="gvhistorico" class="filtrar" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" AutoGenerateColumns="False" Width="576px">
                        <Columns>
                            ...
                            <asp:BoundField DataField="OC_NPREUN2" HeaderText="PRECIO" ItemStyle-Width="70" ItemStyle-HorizontalAlign="Right" />
                            <asp:BoundField DataField="OC_CNUMORD" HeaderText="N DOC" ItemStyle-Width="80" ItemStyle-HorizontalAlign="Right" />
                            <asp:BoundField DataField="OC_CCOMENTA" HeaderText="N DOC" ItemStyle-Width="80" ItemStyle-HorizontalAlign="Right" />
