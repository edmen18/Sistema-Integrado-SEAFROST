namespace ENTITY
{
    ...
    public partial class FT0003NUME
    {
        ...
        public static void actualizaNumer(FT0003NUME dato)
        {
            ...
            try
            {
                ...
                using (RSFACAR ctx = new RSFACAR())
                {
                    ...
                    IDNDOC.TN_NNUMINI = dato.TN_NNUMINI;//AGREGO
        ...
        public static string obtenerNumeracion(FT0003NUME DATA)
        {
            ...
            try
            {
                using (var ctx = new RSFACAR())
                {
                    cuenta = Convert.ToInt32(ctx.FT0003NUME.Where(x => x.TN_CCODIGO == DATA.TN_CCODIGO && x.TN_CNUMSER == DATA.TN_CNUMSER).Max(x => x.TN_NNUMERO));
            ...
            cuenta = cuenta + 1;
            codID = cuenta.ToString("D7");
            codID = DATA.TN_CNUMSER + "" + codID;
            return codID;
        }
    }
}
