                                                                   ...
                                                                   <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                                    <div class="check">
                                                                                       ...
                                                                                       <asp:CheckBox ID="cbsel5" runat="server" class="check1"  />
                                                                                        </div>
                                                                   ...
                                                                   <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                              ...
                                                                              <asp:TextBox ID="txtprecio6"  class ="numeric" runat="server" Width="40"></asp:TextBox>
                                                                                       <asp:CheckBox ID="cbsel6" runat="server" class="check1"   />
                                                                                        </div>
                                                                   ...
                                                                   <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                       <div class ="check">
                                                                            ...
                                                                            <asp:CheckBox ID="cbsel7" runat="server" class ="check1" />
                                                                            </div>
                                                                 ...
                                                                 <asp:TemplateField HeaderText="P8">
                                                                    ...
                                                                    <ItemTemplate>
                                                                       <div class ="check">
                                                                        ...
                                                                        <asp:CheckBox ID="cbsel8" runat="server" class ="check1" />
                                                                           </div>
                                                                 ...
                                                                 <asp:TemplateField HeaderText="P9">
                                                                    ...
                                                                    <ItemTemplate>
                                                                         <div class ="check">
                                                                          ...
                                                                          <asp:CheckBox ID="cbsel9" runat="server" class ="check1"  />
                                                                            </div>
                                                               ...
                                                               <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                     <div class ="check">
                                                                         <asp:DropDownList ID="ddlmoneda10"  class="moneda" runat="server"></asp:DropDownList>
                                                                            ...
                                                                            <asp:CheckBox ID="cbsel10" runat="server" class ="check1"/>
                                                                         </div>
                                                                 ...
                                                                 <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                         ...
                                                                         <asp:CheckBox ID="cbsel11" runat="server"  class ="check1" />
                                                                          </div>
                                                                    ...
                                                                    <ItemTemplate>
                                                                       ...
                                                                       <asp:DropDownList ID="ddlmoneda12"  class="moneda" runat="server"></asp:DropDownList>
                                                                        <asp:TextBox ID="txtprecio12"   class ="numeric" runat="server" Width="40"></asp:TextBox>
                                                                            <asp:CheckBox ID="cbsel12" runat="server"  class ="check1" />
                                                                             </div>
                                                                 ...
                                                                 <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                      <div class ="check">
                                                                        ...
                                                                        <asp:CheckBox ID="cbsel13" runat="server" class ="check1"  />
                                                                            </div>
                                                                    ...
                                                                    <ItemTemplate>
                                                                         <div class ="check">
                                                                           ...
                                                                           <asp:TextBox ID="txtprecio14"   class ="numeric" runat="server" Width="40"></asp:TextBox>
                                                                            <asp:CheckBox ID="cbsel14" runat="server" class ="check1" />
                                                                            </div>
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                       <div class ="check">
                                                                          ...
                                                                          <asp:CheckBox ID="cbsel15" runat="server" class ="check1"/>
                                                                            </div>
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                           <div class ="check">
                                                                            ...
                                                                            <asp:CheckBox ID="cbsel16" runat="server" class ="check1" />
                                                                            </div>
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                         <div class ="check">
                                                                            ...
                                                                            <asp:CheckBox ID="cbsel17" runat="server" class ="check1"  />
                                                                           </div>
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                       <div class ="check">
                                                                            ...
                                                                            <asp:CheckBox ID="cbsel18" runat="server" class ="check1"/>
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                         <div class ="check">
                                                                            ...
                                                                            <asp:CheckBox ID="cbsel19" runat="server" class ="check1" />
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                       <div class ="check">
                                                                            ...
                                                                            <asp:CheckBox ID="cbsel20" runat="server" class ="check1" />
                                                                            </div>
                                                                    ...
                                                                    <ItemTemplate>
                                                                      <div class ="check">
                                                                          <asp:DropDownList ID="ddlmoneda21"  class="moneda" runat="server"></asp:DropDownList>
                                                                           ...
                                                                           <asp:CheckBox ID="cbsel21" runat="server" class ="check1"  />
                                                                            </div>
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <div class ="check">
                                                                            ...
                                                                            <asp:CheckBox ID="cbsel22" runat="server"  class ="check1"/>
                                                                            </div>
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                       ...
                                                                       <asp:DropDownList ID="ddlmoneda23"  class="moneda" runat="server"></asp:DropDownList>
                                                                            ...
                                                                            <asp:CheckBox ID="cbsel23" runat="server" class ="check1"/>
                                                                            </div>
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <div class ="check">
                                                                            ...
                                                                            <asp:CheckBox ID="cbsel24" runat="server"  class ="check1" />
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                         <div class ="check">
                                                                            ...
                                                                            <asp:CheckBox ID="cbsel25" runat="server" class ="check1"  />
                                                                             </div>
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                         <div class ="check">
                                                                            ...
                                                                            <asp:CheckBox ID="cbsel26" runat="server"  class ="check1" />
                                                                            </div>
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <div class ="check">
                                                                           ...
                                                                           <asp:CheckBox ID="cbsel27" runat="server"  class ="check1" />
                                                                            </div>
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <asp:DropDownList ID="ddlmoneda28"  class="moneda" runat="server"></asp:DropDownList>
                                                                            ...
                                                                            <asp:CheckBox ID="cbsel28" runat="server"  class ="check1" />
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                         <div class ="check">
                                                                            ...
                                                                            <asp:CheckBox ID="cbsel29" runat="server" class ="check1"  />
                                                                            </div>
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                         <div class ="check">
                                                                            ...
                                                                            <asp:CheckBox ID="cbsel30" runat="server" class ="check1" />
                                                                             </div>
                                                                    ...
                                                                    <ItemTemplate>
                                                                       <div class ="check">
                                                                           <asp:DropDownList ID="ddlmoneda31"  class="moneda" runat="server"></asp:DropDownList>
                                                                            ...
                                                                            <asp:CheckBox ID="cbsel31" runat="server" class ="check1"  />
                                                                            </div>
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                          <div class ="check">
                                                                           ...
                                                                           <asp:CheckBox ID="cbsel32" runat="server" class ="check1"   />
                                                                              </div>
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <div class ="check">
                                                                            ...
                                                                            <asp:CheckBox ID="cbsel33" runat="server" class ="check1" />
                                                                            </div>
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                         ...
                                                                         <asp:CheckBox ID="cbsel34" runat="server" class ="check1" />
                                                                         </div>
                                                                ...
                                                                <asp:CheckBox ID="cbsel35" runat="server" class ="check1" />
                                                                            </div>
