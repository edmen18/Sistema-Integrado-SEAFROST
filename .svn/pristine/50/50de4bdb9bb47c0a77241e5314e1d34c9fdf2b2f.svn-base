...
public partial class Default2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack) {
            ...
            ddlsarea.DataSource = tabla_d_areausua.Listarsubareasxusua(hfusu.Value);
            ddlsarea.DataBind();
            ...
            if (idproducto == "" || idproducto ==null )
            {
                ...
                txtcuenta.Text = FT0003CTAE.RegistrounCta(verarticu.AR_CCUENTA.Trim()) ;
                txtidcuenta.Text = verarticu.AR_CCUENTA.Trim();
                txtprod2.Text = verarticu.AR_CDESCRI;
                txttar.Text = verarticu.AR_NPRECOM.ToString();
    ...
    [System.Web.Services.WebMethod]
    [ScriptMethod()]
    public static List<FT0003CTAE> listactaexis(string texto)
    {
        return FT0003CTAE.ListarCtaE(texto);
    }
    ...
    {
        if (FT0003CTAE.RegistrounCta(txtidcuenta.Text) == "")
        {
            ...
            txtcuenta.Text = FT0003CTAE.RegistrounCta(txtidcuenta.Text);
            ddlsarea.Focus();
        }
    }
    ...
    protected void btgrabar_Click(object sender, EventArgs e)
    {
        ...
        }else if (txtidprove.Text=="") 
        {
            ...
            string informa = "<html><body> <table border='1' style='font-size:14px'><tr><td colspan='2' align='center' bgcolor='#7ACAFF'> <b>" + "SERVICIO" + "</b></td></tr><tr><td colspan='2' align='center' bgcolor='#FFCC99'>" + txtprod2.Text + "</td></tr><tr><td>" + " PROVEEDOR: "+ "</td><td>" + txtprove.Text + "</td></tr><tr><td>" + " TARIFA: " + "</td><td>" + Convert.ToDecimal( string.Format("{0:00.0000}", txttar.Text)) + "</td></tr><tr><td>"
            ...
            {              
                if (nrepetic > 0) 
                {
                    ...
                    if (txtidcuenta.Text == "")
                    {
                        ...
                        foreach (var d in enviousuaxarea)
                        {
                            ...
                            {
                                Cls_Utilidades.enviarMail("programador1@seafrost.com.pe", "mail.seafrost.com.pe", "SEA2015frost", informa, "CREACION DE TARIFA POR ASIGNAR CUENTA", d.UA_CORREO, "", "", fiche);
                            }
                        }
                    }
                    else
                    {
                        ...
                        foreach (var d in enviousuaxarea)
                        {
                            ...
                            {
                                Cls_Utilidades.enviarMail("programador1@seafrost.com.pe", "mail.seafrost.com.pe", "SEA2015frost", informa, "CREACION DE TARIFA POR APROBAR", d.UA_CORREO, "", "", fiche);
                            }
                        }
                    }
                ...
                foreach (var d in enviousuaxarea) { 
                    if (d.UA_CORREO.Trim() != "" || d.UA_CORREO != null) { 
                    Cls_Utilidades.enviarMail("programador1@seafrost.com.pe", "mail.seafrost.com.pe", "SEA2015frost", informa, "MODIFICACION DE TARIFA POR APROBAR", d.UA_CORREO, "", "", fiche);
                    }
                }
