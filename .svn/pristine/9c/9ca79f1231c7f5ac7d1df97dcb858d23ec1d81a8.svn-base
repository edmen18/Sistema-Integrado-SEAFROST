               ...
               List<vista_reporte_liquidacion> detalle1 = new List<vista_reporte_liquidacion>();
                ...
                foreach (vista_solicitud a in proveedor)
                {
                    ...
                    worksheet.Range("C" + contprov.ToString() + ":J" + contprov.ToString()).Row(1).Merge();
                        ...
                        worksheet.Cell("C" + contcab.ToString()).SetValue("ORDEN N°").Style.Font.SetBold(true);
                        worksheet.Cell("D" + contcab.ToString()).SetValue("FECHA_EMISION").Style.Font.SetBold(true);
                        worksheet.Cell("E" + contcab.ToString()).SetValue("FECHA_REG.").Style.Font.SetBold(true);
                        worksheet.Cell("F" + contcab.ToString()).SetValue("MOTIVO").Style.Font.SetBold(true);
                        worksheet.Cell("G" + contcab.ToString()).SetValue("MONTO TOTAL").Style.Font.SetBold(true);
                        ...
                        worksheet.Cell("J" + contcab.ToString()).SetValue("MONEDA").Style.Font.SetBold(true);
                        worksheet.Cell("K" + contcab.ToString()).SetValue("RETENCION").Style.Font.SetBold(true);
                        worksheet.Cell("L" + contcab.ToString()).SetValue("DETRACCION").Style.Font.SetBold(true);
                                            ...
                                            foreach (vista_reporte_liquidacion b in detalle1)
                    {
                        if (a.OC_CCODPRO == b.OC_CCODPRO)
                        {
                                ...
                                worksheet.Cell("C" + cont2.ToString()).Value = ("'" + b.OC_CNUMORD + "");
                                worksheet.Cell("B" + cont2.ToString()).Value = ("'" + b.ANT_CODIGO + "");
                                worksheet.Cell("D" + cont2.ToString()).Value = b.OC_FECEMI;
                                worksheet.Cell("E" + cont2.ToString()).Value = b.FECHA_REG;
                                worksheet.Cell("F" + cont2.ToString()).Value = b.MOTIVO;
                                ...
                                worksheet.Cell("J" + cont2.ToString()).Value = b.OC_CODMON;
                                worksheet.Cell("K" + cont2.ToString()).Value = b.RETENCION;
                                worksheet.Cell("L" + cont2.ToString()).Value = b.DETRACCION;
            ...
            if (rbnumero.Checked)
            {
               ...
               // detplanilla.OC_CCODPRO = txtidpro.Text;
                ...
                if (rbfechas.Checked)
                {
                    ...
                    worksheet.Cell("C7").SetValue("ORDEN N°").Style.Font.SetBold(true);
                    worksheet.Cell("D7").SetValue("FECHA_EMISION").Style.Font.SetBold(true);
                    worksheet.Cell("E7").SetValue("FECHA REG.").Style.Font.SetBold(true);
                    worksheet.Cell("F7").SetValue("PROVEEDOR").Style.Font.SetBold(true);
                    worksheet.Cell("G7").SetValue("MONTO TOTAL").Style.Font.SetBold(true);
                    worksheet.Cell("H7").SetValue("%").Style.Font.SetBold(true);
                    worksheet.Cell("I7").SetValue("ANTICIPO").Style.Font.SetBold(true);
                    worksheet.Cell("J7").SetValue("MONEDA").Style.Font.SetBold(true);
                    worksheet.Cell("K7").SetValue("RETENCION").Style.Font.SetBold(true);
                    worksheet.Cell("L7").SetValue("DETRACCION").Style.Font.SetBold(true);
                    ...
                    foreach (vista_reporte_liquidacion b in detalle1)
                    {
                        ...
                        worksheet.Cell("D" + cont2.ToString()).Value = b.OC_FECEMI;
                        worksheet.Cell("E" + cont2.ToString()).Value = b.FECHA_REG;
                        worksheet.Cell("F" + cont2.ToString()).Value = b.OC_CRAZSOC;
                        worksheet.Cell("G" + cont2.ToString()).Value = b.OC_MONTO_PEDIDO;
                        worksheet.Cell("H" + cont2.ToString()).Value = b.OC_PERCENTAJE;
                        worksheet.Cell("I" + cont2.ToString()).Value = b.OC_ANTICIPO;
                        worksheet.Cell("J" + cont2.ToString()).Value = b.OC_CODMON;
        ...
        /////////////************** reporte uno por uno *********////////////////////////
            ...
            if (rbproveedor.Checked)
            {
                ...
                worksheet.Range("C6:J6").Row(1).Merge();
                    ...
                    worksheet.Cell("C8").SetValue("ORDEN N°").Style.Font.SetBold(true);
                    worksheet.Cell("D8").SetValue("FECHA_EMISION").Style.Font.SetBold(true);
                    worksheet.Cell("E8").SetValue("FECHA REG.").Style.Font.SetBold(true);
                    worksheet.Cell("F8").SetValue("MOTIVO").Style.Font.SetBold(true);
                    worksheet.Cell("G8").SetValue("MONTO TOTAL").Style.Font.SetBold(true);
                    worksheet.Cell("H8").SetValue("%").Style.Font.SetBold(true);
                    worksheet.Cell("I8").SetValue("ANTICIPO").Style.Font.SetBold(true);
                    worksheet.Cell("J8").SetValue("MONEDA").Style.Font.SetBold(true);
                    worksheet.Cell("K8").SetValue("RETENCION").Style.Font.SetBold(true);
                    worksheet.Cell("L8").SetValue("DETRACCION").Style.Font.SetBold(true);
