<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ALStockval.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:HiddenField runat="server" ID="hfusu" />
        <div id="contenedor">
        <fieldset>
            <legend>STOCK VALORIZADO POR PERIODO</legend>
            ...
            <table>
                ...
                <tr>
                    <td>Almacen</td>
                    <td>
                          <asp:DropDownList ID="ddlalmacen" runat="server" Width="350"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td>Producto:</td>
