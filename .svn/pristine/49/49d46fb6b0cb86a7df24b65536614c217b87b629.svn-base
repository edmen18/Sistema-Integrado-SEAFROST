     ...
     $(".EXCEL").click(function () {
        ...
        if ($('#MainContent_ddlorden').val() == "A") {
            ...
            var anio = $('#MainContent_txtannio').val();
                    periodo = anio + mes;
                   almacen = $('#MainContent_ddlalmacen').val();
                   window.open("../ALMACEN/REPORTES/stocvalorizado/SVEXCEL.aspx?PERIODO= " + periodo + "&ALMACEN=" + almacen + "&MES=" + mes + "&ANNIO=" + anio + "&ARTICULO1=" + $('#MainContent_txtcodigo').val() + "&ARTICULO2=" + $('#MainContent_txtcodigofin').val() + " &MONEDA=" + moneda + " &indicador=" + "TAF", '_blank');
               }
        if ($('#MainContent_ddlorden').val() == "06") {
            var periodo = "";
            var almacen = "";
            ...
            periodo = anio + mes;
            almacen = $('#MainContent_ddlalmacen').val();
            window.open("../ALMACEN/REPORTES/stocvalorizado/SVEXCEL.aspx?PERIODO= " + periodo + "&MES=" + mes + "&ANNIO=" + anio + "&CODIGO=" + $('#MainContent_ddlorden').val() + "&ALMACEN=" + almacen + "&ARTICULO1=" + $('#MainContent_txtcodigo').val() + "&ARTICULO2=" + $('#MainContent_txtcodigofin').val() + " &MONEDA=" + moneda + " &indicador=" + "TG", '_blank');
        }
        if ($('#MainContent_ddlorden').val() == "38") {
            var periodo = "";
            var almacen = "";
            ...
            periodo = anio + mes;
            almacen = $('#MainContent_ddlalmacen').val();
            window.open("../ALMACEN/REPORTES/stocvalorizado/SVEXCEL.aspx?PERIODO= " + periodo + "&MES=" + mes + "&ANNIO=" + anio + "&CODIGO=" + $('#MainContent_ddlorden').val() + "&ALMACEN=" + almacen + "&ARTICULO1=" + $('#MainContent_txtcodigo').val() + "&ARTICULO2=" + $('#MainContent_txtcodigofin').val() + " &MONEDA=" + moneda + " &indicador=" + "TF", '_blank');
        }
        if ($('#MainContent_ddlorden').val() == "V7") {
            var periodo = "";
            var almacen = "";
            ...
            periodo = anio + mes;
            almacen = $('#MainContent_ddlalmacen').val();
            window.open("../ALMACEN/REPORTES/stocvalorizado/SVEXCEL.aspx?PERIODO= " + periodo + "&MES=" + mes + "&ANNIO=" + anio + "&CODIGO=" + $('#MainContent_ddlorden').val() + "&ALMACEN=" + almacen + "&ARTICULO1=" + $('#MainContent_txtcodigo').val() + "&ARTICULO2=" + $('#MainContent_txtcodigofin').val() + " &MONEDA=" + moneda + " &indicador=" + "TM", '_blank');
        }
        if ($('#MainContent_ddlorden').val() == "39") {
            var periodo = "";
            var almacen = "";
            ...
            periodo = anio + mes;
            almacen = $('#MainContent_ddlalmacen').val();
            window.open("../ALMACEN/REPORTES/stocvalorizado/SVEXCEL.aspx?PERIODO= " + periodo + "&MES=" + mes + "&ANNIO=" + anio + "&CODIGO=" + $('#MainContent_ddlorden').val() + "&ALMACEN=" + almacen + "&ARTICULO1=" + $('#MainContent_txtcodigo').val() + "&ARTICULO2=" + $('#MainContent_txtcodigofin').val() + " &MONEDA=" + moneda + " &indicador=" + "TMO", '_blank');
        }
        if ($('#MainContent_ddlorden').val() == "07") {
            var periodo = "";
            var almacen = "";
            ...
            periodo = anio + mes;
            almacen = $('#MainContent_ddlalmacen').val();
            window.open("../ALMACEN/REPORTES/stocvalorizado/SVEXCEL.aspx?PERIODO= " + periodo + "&MES=" + mes + "&ANNIO=" + anio + "&CODIGO=" + $('#MainContent_ddlorden').val() + "&ALMACEN=" + almacen + "&ARTICULO1=" + $('#MainContent_txtcodigo').val() + "&ARTICULO2=" + $('#MainContent_txtcodigofin').val() + " &MONEDA=" + moneda + " &indicador=" + "TC", '_blank');
        }
       }
