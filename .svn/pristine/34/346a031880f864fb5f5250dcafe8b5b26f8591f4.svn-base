namespace ENTITY
{
    ...
    public partial class AL0003MOVG
    {
        ...
        public static List<AL0003MOVG> DetalleMovg(string fdoc,string fdoc2,string codigo)
        {
            ...
            List<AL0003MOVG> datos = new List<AL0003MOVG>();
            try
            {
        ...
        public static List<AL0003MOVG> DetalleMovgdistinc(string fdoc, string fdoc2, string codigo, string codigo2, string almacen)
        {
            string finicio = "", ffina = "", diax = "";
            finicio = "01/" + fdoc.Substring(5, 2) + "/" + fdoc.Substring(0, 4);
            diax = DateTime.DaysInMonth(Convert.ToInt32(fdoc2.Substring(0, 4)), Convert.ToInt32(fdoc2.Substring(5, 2))).ToString("D2");
            ...
            string[] listaprod = new string[aff.Count()];
            int ccod = 0;
            ...
            try
            {
                using (var ctx = new RSFACAR())
                {
                    datos = (from AL0003MOVG in ctx.AL0003MOVG
                             ...
                             && (listaprod).Contains(AL0003MOVG.C6_CCODIGO)
                             select new
                             {
                                 AL0003MOVG.C6_CCODIGO//,
                                 //AL0003MOVG.C6_CGLOSA,
        ...
        public static AL0003MOVG DetalleMovgSuma(string fdoc, string fdoc2, string codigo, string insa, string almacen)
        {
            string finicio = "", ffina = "", diax = "";
            finicio = "01/" + fdoc.Substring(5, 2) + "/" + fdoc.Substring(0, 4);
            diax = DateTime.DaysInMonth(Convert.ToInt32(fdoc2.Substring(0, 4)), Convert.ToInt32(fdoc2.Substring(5, 2))).ToString("D2");
