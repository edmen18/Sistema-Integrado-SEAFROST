<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="SOaprobacion.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(window).load(function () {
            ...
            function FiltragridxUSuArea() {
                var ADATA = {};
                ADATA.SM_USUA = $("#hfusu").val();
                ...
                $.ajax({
                    type: "POST",
                    url: "SOaprobacion.aspx/ListarValesFesp",
                ...
                success: function (data) {
                    if (data.d.length > 0) {
                        ...
                        for (var i = 0; i < data.d.length; i++) {
                            ...
                            //alert(data.d[i].SR_NSKDIS);
                            $('td:eq(3) :text', row0).val("");
                            if (nrxusu < 1) {
                                $("td", row0).eq(1).html(data.d[i].SR_NSKDIS);
                                //$('td:eq(4) :text', row0).attr("disabled",true);
                            } else {
                                //actualizar cuando se comience a generar ordenes mediante el solicitante
                                $("td", row0).eq(1).html(data.d[i].SR_NSKDIS);
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#MainContent_btbusca").click(function () {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="contenedor" style="float: left; width: 1000px">
        <fieldset style="float: left; width: 900px">
            <legend>APROBACION DE SOLICITUD</legend>
            ...
            <table>
                ...
                <tr>
                    <td>Estado: </td>
                    <td>
                        <asp:DropDownList runat="server" ID="ddlestad" Width="230"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td>N° Solicitud: </td>
                    <td>
                        <input type="text" runat="server" id="txtnuma" style="width: 155px" />

                        <%-- </td>
                         <td>--%>
                        <input type="button" runat="server" id="btbusca" value="Buscar" class="btn" />
                    </td>
                </tr>
                <%--                <tr>
                    <td colspan="3">
            ...
            <table>
                ...
                <tr>
                    <td colspan="4">
                        <div id="expo">
                            <asp:GridView ID="gvsolicitudes" class="filtrar" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" AutoGenerateColumns="False" Width="958px" OnRowCreated="griddata_RowCreated">
                                <Columns>
                                    <asp:BoundField DataField="SM_ID" HeaderText="N° DOC" ItemStyle-Width="10">
                                        <ItemStyle CssClass="id"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="SM_IDSOLI" HeaderText="SOLICITANTE" ItemStyle-Width="250">
                                        <ItemStyle CssClass="producto"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="SM_GLOSA" HeaderText="FECHA" ItemStyle-Width="100" ItemStyle-HorizontalAlign="center" />
                                    <asp:BoundField DataField="SM_AREA" HeaderText="AREA" ItemStyle-Width="100" ItemStyle-HorizontalAlign="center">
                                        <ItemStyle CssClass="moneda"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="SM_ESTADO" HeaderText="ESTADO" ItemStyle-Width="100" ItemStyle-HorizontalAlign="center" />
                                    <asp:BoundField DataField="SM_USUA" HeaderText="USUARIO" ItemStyle-Width="200" ItemStyle-HorizontalAlign="center" />
                                   ...
                                   <asp:TemplateField ItemStyle-Width="11px" HeaderText="EDI"> 
                                    ...
                                    <asp:TemplateField ItemStyle-Width="11px" HeaderText="INF">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="11px" HeaderText="IMP">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="11px" HeaderText="ANU">
                                        <ItemTemplate>
                                            <div class="anu" style="text-align: center">
                                                <div>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="11px" HeaderText="ATE">
                                        <ItemTemplate>
                                            <div class="ate" style="text-align: center">
                                                <div>
    ...
    <div id="dvdetalle" style="position: center; display: compact">
    ...
    <div id="dvatender" style="display: compact">
        <div style="background-color: #006699">
            <table>
                <tr>
                    <td style="text-align: right">
    ...
    <div id="serie" style="display: compact">
