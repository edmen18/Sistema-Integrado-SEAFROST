...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            function aprobardet(numeroorden, indiceap, item) {
                var idnumd = numeroorden;
                var DETAPRUEBA = {};
                DETAPRUEBA.OC_CNUMORD = numeroorden;
                DETAPRUEBA.OC_CESTADO = indiceap;
                DETAPRUEBA.OC_CITEM = item;
                    ...
                    success: function (data) {
                        ...
                        if (data.d.length > 0) {
                            ...
                            for (var i = 0; i < data.d.length; i++) {
                                ...
                                $("td", row).eq(5).html(data.d[i].OC_NPREUN2.toFixed(2));
                                ...
                                $("td", row).eq(10).html(data.d[i].OC_NPREUNI.toFixed(2));
            ...
            function filtarocomprapopup() {
              ...
              if ((VC.OC_CSITORD != "-1" || VC.OC_CTIPORD != "-1" || VC.OC_CCODPRO != "") && (VC.OC_DFECDOC != "" && VC.OC_DFECENT != ""))
                {
                ...
                if ((VC.OC_CSITORD == "-1" && VC.OC_CTIPORD == "-1" && VC.OC_CCODPRO == "") && (VC.OC_DFECDOC != "" && VC.OC_DFECENT != "")) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        url: "OCemision.aspx/ListarCabOCpopupFechas",
                        data: '{VC: ' + JSON.stringify(VC) + '}',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.d.length > 0) {
                           // alert(data.d.length)
                            for (var i = 0; i <= data.d.length; i++) {
                                // alert(data.d[i].OC_CITEM);
                                //item=data.d[i].OC_CITEM;
                                aprobardet(numeroorden, indiceap, data.d[i].OC_CITEM);
                            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <table>
        <tr>
            <td>
                <asp:GridView ID="gvordencompra" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" AutoGenerateColumns="False" Width="467px">
                    <Columns>
