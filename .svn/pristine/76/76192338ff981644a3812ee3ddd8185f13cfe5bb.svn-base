...
<%@ Page Title="Aprobar Caja Chica" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="AprobacionCajaChica.aspx.cs" Inherits="FINANZAS_TESORERIA_CAJACHICA_AprobacionCajaChica" %>
 ...
 <asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
            ...
            $("#MainContent_txtcuenta").autocomplete(
  {
      source: function (request, response) {
          $.ajax({
              url: "AprobacionCajaChica.aspx/ListarCtaE1",
            ...
            $("#MainContent_txtcodsolicitante").autocomplete(
   {
       source: function (request, response) {
           $.ajax({
               url: "AprobacionCajaChica.aspx/ListarProveedoresporid",
            ...
            $("#MainContent_txtcodbanco").autocomplete(
{
    source: function (request, response) {
        $.ajax({
            url: "AprobacionCajaChica.aspx/ListarBancosProg",
        ...
        $('#MainContent_txtbancob').val(str);
            ...
            $("#MainContent_txtbancob").autocomplete(
          {
            ...
            $(".modificar").click(function () {
                ...
                for (var area = 0 ; area < document.getElementById("<%= ddltipoentrega.ClientID %>").length; area++) {
                   if (document.getElementById("<%= ddltipoentrega.ClientID %>").options[area].text == (TIPO))
                        document.getElementById("<%= ddltipoentrega.ClientID %>").selectedIndex = area;
                 }
            ...
            function generar() {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: "AprobacionCajaChica.aspx/GENERAR",
                    data: "",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: false,
            ...
            $(".Aprobar").click(function () {
                if (Operacion.mask('txtestado').val().trim() == "F") {
            ...
            $(".Desaprobar").click(function () {
                if (Operacion.mask('txtestado').val().trim() == "A") {
                    if (confirm("¿ Desea desaprobar esta solicitud ? ")) {
                        ActualizaSolicitud("F");
                    }

                }
                else {
                    alert("No es posible la operación ya que la solicitud se encuentra " + (Operacion.mask('txtestado').val() == "F" ? "FINALIZADA" : Operacion.mask('txtestado').val() == "L" ? "LIQUIDADA" : "ANULADA"));
                }
            ...
            function ActualizaSolicitud(ESTADO) {
                ...
                datos.ESTADO = ((Operacion.mask('txtusuario2').val() != "" && Operacion.mask('txtusuario1').val() != "") ? "A" : "F");
                }
                ...
                if (ESTADO.trim() == "F") { // SI LO ESTOY DESAPROBANDO
                    datos.APROB1 = null;
                    datos.APROB2 = null;
                    datos.APROB3 = null;
                    datos.ESTADO = "F";
                ...
                $.ajax({
                    type: "POST",
                    url: "AprobacionCajaChica.aspx/modificaoer",
            ...
            function ConsultaUno(TIPO) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: "AprobacionCajaChica.aspx/ListarUnDato",
     ...
     <table>
           <tr>
               ...
               <td>
                   ...
                   <asp:TextBox ID="ddltipoentrega" runat="server" Width="38px" ReadOnly="true"></asp:TextBox>
                   <asp:TextBox ID="txtcajas" runat="server" Width="87px" Text="CAJA" ReadOnly="true"></asp:TextBox>
                    </td>
           </tr>
           </table>
        <table>
