...
public partial class listadoOC : System.Web.UI.Page
{
    ...
    public void ListaDetalle()
    {
        ...
        dtGetDatae1.Columns.Add("PRECIO_MOSTRAR");
        dtGetDatae1.Columns.Add("PRECIO_MOSTRAR_TOTAL");
    ...
    protected void Page_Load(object sender, EventArgs args)
    {
        if (!this.IsPostBack)
        {
          //  ScriptManager.RegisterStartupScript(this, typeof(System.Web.UI.Page), "Alerta", Cls_Utilidades.mensajescript("jimmy"), false);
  ...
  protected void ib_editar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string usuario = gvRequerimientos.DataKeys[row.RowIndex].Values["RC_CUSUCRE1"].ToString().Trim();
  ...
  protected void ib_eliminar_Click(object sender, ImageClickEventArgs e)
    ...
    protected void ibimprimir_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string idnumor = gvRequerimientos.Rows[row.RowIndex].Cells[0].Text;
