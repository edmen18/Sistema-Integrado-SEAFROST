...
public partial class ContabilizaDOS : System.Web.UI.Page
{
    ...
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod()]
    public static void actualizaBALS(CT0003COST16 BDATA)
    {   //ASIENTO GESTION
        CT0003COST16.actualizar(BDATA);
    }
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod()]
    ...
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod()]
    public static List<CT0003PLEM> listactas(string texto)
    {
        return CT0003PLEM.ListarCtaE(texto);
    }
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod()]
    public static List<CT0003TAGE> listarTGxD(CT0003TAGE DATA)
    {
        return CT0003TAGE.ListarTGxD(DATA);
    }
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod()]
    public static string costeocta(tabla_dist_costeo DATA)
    {
        return tabla_dist_costeo.costeocta(DATA);
    }
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod()]
    public static List<tabla_d_ordfac.vista_dordfac> getDOSE(tabla_d_ordfac.vista_dordfac DATA)
    {
        return tabla_d_ordfac.getList(DATA);
    }
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod()]
    public static List<SCabecera> listaCSE(CO0003MOVC PDATA, string[] IC)
    {
        return CO0003MOVC.listaCSE(PDATA, IC);
    }
    [WebMethod]
    [System.Web.Script.Services.ScriptMethod()]
    public static List<SCabecera> listaCXSE(CO0003MOVC PDATA, string[] IC) {
        return CO0003MOVC.listaCAPEXA(PDATA, IC);
    }
