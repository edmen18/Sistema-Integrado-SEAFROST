<%@ Page Title="Logística" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="verOC.aspx.cs" Inherits="verOC" %>
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
   ...
   <legend style="font-weight: bold; background-color: #99CCFF;" > <asp:Label ID="Label9" runat="server" Text="REQUERIMIENTO" Font-Bold="True" Font-Size="12pt"></asp:Label></legend>
                    ...
                    <tr>
                        <td  >
                            ...
                            <table >
                                <tr>
                                    <td>
                                        <asp:Panel ID="pnCabecera" runat="server" Enabled="False">
                                              <table >
                                            <tr>
                                                <td>
                                        ...
                                        <asp:DropDownList ID="ddlccosto" runat="server"></asp:DropDownList>
                                                    <asp:Label ID="lblcodcosto" runat="server" ></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2"> 
                                        ...
                                        <table >
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnGrabar" runat="server" Text="Grabar Cabecera" OnClick="btnGrabar_Click" Width="115px" Visible="False" />
                                                <br />
                                        ...
                                        <asp:TextBox ID="txtCantidaad" class="numeric" runat="server"></asp:TextBox>
                                                </td>
                                       ...
                                       <asp:Button ID="btnModificar" runat="server" Text="Modificar" OnClick="btnModificar_Click" Visible="False"  />
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="gvDetalle" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" OnRowDataBound="gvDetalle_RowDataBound" ShowFooter="True">
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="RD_COBS" HeaderText="OBSERVACION" />
                                                             <asp:BoundField DataField="RD_CCENCOS" HeaderText="CCOSTO" />
                                            ...
                                            <table ALIGN=center>
                                                ...
                                                <tr>
                                                    <td ALIGN=center>VB SOLICITANTE</td>
                                                    <td ALIGN=center>VB GERENTE</td>
                                                </tr>
                                            </table>
                                        </asp:Panel>
