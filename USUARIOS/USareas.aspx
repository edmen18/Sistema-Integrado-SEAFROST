<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="USareas.aspx.cs" Inherits="Default2" %>
    ...
    <script type="text/javascript">
        ...
        $(window).load(function () {
            ...
            $(function () {
                ...
                $(".chktodosn03").click(function () {
                Operacion.Checktodos(this, "<%= gvgerencia.ClientID %>", 2);
                });
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:HiddenField runat="server" ID="hfusu" />
        <div id="contenedor">
        <fieldset>
            <legend>ASIGNACION DE USUARIOS POR AREA</legend>
            ...
            <table>
                <tr>
                    <td colspan="4">
                        <asp:GridView ID="gvgerencia" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"  AutoGenerateColumns="False" Width="408px">
                                     <Columns>
                                         <asp:BoundField DataField="GG_ID" HeaderText="ID"  ItemStyle-Width="10"  />
                                         <asp:BoundField DataField="GG_DESCRI" HeaderText="GERENCIAS"  ItemStyle-Width="350"  />
                               
                                         <asp:TemplateField ItemStyle-Width="11px" >
                                         <HeaderTemplate> 
                                                  <div class ="ch03" style="text-align:center" >
                                                      <input type="checkbox" class="chktodosn03" />
                                                 </div>
                                          </HeaderTemplate>
                                             
                                             <ItemTemplate>
                                                 <div class ="ver" style="text-align:center">
                                                     <asp:CheckBox runat="server" ID="chkSeleccionn" OnCheckedChanged="chkSeleccionn_CheckedChanged" AutoPostBack="true" />
                ...
                <tr>
                    <td colspan="6" style="vertical-align:top">
                          <asp:GridView ID="gvareas" class="filtrar" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"  AutoGenerateColumns="False" Width="719px"  >
                                     <Columns>
                                         <asp:BoundField DataField="SA_ID" HeaderText="ID"  ItemStyle-Width="10"  />
                                         <asp:BoundField DataField="SA_DESC" HeaderText="AREA"  ItemStyle-Width="300"  />
                                         <asp:BoundField DataField="SA_NAPROB" HeaderText="N°APROB"  ItemStyle-Width="10"  />
                                         <asp:BoundField DataField="SA_GEREN" HeaderText="GERENCIA"  ItemStyle-Width="190"  />
