<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="USsolicitante.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:HiddenField runat="server" ID="hfusu" />
        <div id="contenedor">
        <fieldset>
            <legend>ASIGNACION DE SOLICITANTES POR USUARIO</legend>
                ...
                <tr>
                    <td colspan="4">
                        <asp:GridView ID="gvgerencia" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"  AutoGenerateColumns="False" Width="408px">
                                     <Columns>
                                         <asp:BoundField DataField="TG_CCLAVE" HeaderText="ID"  ItemStyle-Width="10"  />
                                         <asp:BoundField DataField="TG_CDESCRI" HeaderText="SOLICITANTES"  ItemStyle-Width="350"  />
