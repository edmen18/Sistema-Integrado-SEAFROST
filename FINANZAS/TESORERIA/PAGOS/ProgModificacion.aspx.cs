...
public partial class FINANZAS_TESORERIA_PAGOS_ProgModificacion : System.Web.UI.Page
{
    ...
    {
        return CP0003CART.SELECTDETALLESPARAMODPROG(VC);
    }
    ...
    [System.Web.Services.WebMethod]
    [System.Web.Script.Services.ScriptMethod()]
    public static List<CT0003ANEX> GetProveedoresruc(string codigo, string texto)
    {
           return CT0003ANEX.listarAnexo1(codigo,texto);
           
    }
    [System.Web.Services.WebMethod]
    [System.Web.Script.Services.ScriptMethod()]
    public static List<CT0003ANEX> GetProveedoresdes(string codigo, string texto)
    {
        return CT0003ANEX.listarAnexo(codigo, texto);
   ...
   [System.Web.Services.WebMethod]
    ...
    {
        return CP0003PRGC.MODIFICARPROG(CODATA);
    }
    [System.Web.Services.WebMethod]
    [System.Web.Script.Services.ScriptMethod()]
