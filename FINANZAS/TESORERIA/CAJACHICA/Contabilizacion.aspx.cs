...
public partial class FINANZAS_TESORERIA_CAJACHICA_Contabilizacion : System.Web.UI.Page
{
    ...
    public void asiento()
    {
        ...
        dtGetDatae.Columns.Add("FECHA_EMISION");
        dtGetDatae.Columns.Add("FECHA_VENCIMIENTO");
        dtGetDatae.Rows.Add();
        gvasiento.DataSource = dtGetDatae;
        gvasiento.DataBind();
        gvsubdiario27.DataSource = dtGetDatae;
        gvsubdiario27.DataBind();
    }
    ...
    {
        tabla_cajas.ActualizarSaldo(COM);
    }
    [System.Web.Services.WebMethod]
    [System.Web.Script.Services.ScriptMethod()]
    ...
    {
        return tabla_cajas.listarCajas1(PDATA);
    }
