...
public partial class ConsultaArticuloProveedor : System.Web.UI.Page
{
    ...
    protected void btnBuscar_Click(object sender, EventArgs e)
    {
        ...
        {
            RD_CCODIGO = txtcodprod1.Text 
        };

        gvarticulos.DataSource= CO0003MOVC.ListarHistorialPreciosPorProducto2(REQ);
