<%@ Page Title="Logística" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="kardexAlmacen.aspx.cs" Inherits="kardexAlmacen" %>
   ...
   <asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <table width="100%" cellpadding="5" cellspacing="5" border="0">
        ...
        <tr>
            <td>
                 <fieldset >
   <legend  > <asp:Label ID="Label9" runat="server" Text="KARDEX DEL ALMACÉN" Font-Bold="True" Font-Size="12pt"></asp:Label></legend>
                                ...
                                <tr>
                                    <td>
                                         <asp:Label ID="FechaInicial" runat="server" Text="Fecha Inicial:" Font-Bold="True"></asp:Label>
                                                    <asp:TextBox ID="txtfechini" runat="server"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                                    <asp:Label ID="FechaFinal" runat="server" Text="Fecha Final:" Font-Bold="True"></asp:Label>
                                         <asp:TextBox ID="txtfechfin" runat="server"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                          <asp:Label ID="Label15" runat="server" Text="Producto Inicial:" Font-Bold="True"></asp:Label>
                                                      ...
                                                      <asp:TextBox ID="txtcodprod1"  OnTextChanged="txtcodprod1_TextChanged" runat="server" Width="170" AutoPostBack="True"></asp:TextBox>
                                                     <asp:TextBox ID="txtproducto" class="tb" runat="server" Width="580px"></asp:TextBox>
                                ...
                                <tr>
                                    <td>
                                          <asp:Label ID="Label1" runat="server" Text="Producto Final:" Font-Bold="True"></asp:Label>
                                                   ...
                                                   <asp:TextBox ID="txtcodprod2"  OnTextChanged="txtcodprod2_TextChanged"  runat="server" Width="170" AutoPostBack="True"></asp:TextBox>
                                                  <asp:TextBox ID="txtproducto1" class="tb2" runat="server" Width="580px"></asp:TextBox>
