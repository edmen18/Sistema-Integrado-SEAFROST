 ...
 <fieldset style="background-color: #99CCFF">
     ...
     <table>
         ...
         <tr>
             ...
             <td>
                  <asp:GridView ID="gvmovimientos" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" AutoGenerateColumns="False" Width="440px" >
                    <Columns>
                        <asp:TemplateField>
                            <HeaderTemplate>
    ...
    <fieldset style="background-color: #99CCFF">
        ...
        <table>
            <tr>
                <td>Fecha Inicial</td> <td class="auto-style2"> <asp:TextBox ID="Txtfinicial" runat="server" Width="319px" Height="16px"></asp:TextBox></td>
            </tr>
             <tr>
                <td>Fecha Final</td> <td class="auto-style2"> <asp:TextBox ID="txtffinal" runat="server" Width="319px" Height="17px"></asp:TextBox></td>
            </tr>
             <tr>
                <td>Ingrese el Dato inical</td> <td class="auto-style2"> <asp:TextBox ID="txtdato" runat="server" Width="320px" Height="16px"></asp:TextBox>
                 <asp:TextBox ID="txtcodigo" runat="server" Width="320px"></asp:TextBox>
                   
                 </td>
            </tr>
            <tr>
                <td>Ingrese el Dato final</td> <td class="auto-style2"> <asp:TextBox ID="txtdato1" runat="server" Width="320px" Height="16px"></asp:TextBox>
                 <asp:TextBox ID="txtcodigofin" runat="server" Width="320px"></asp:TextBox>
                   
                 </td>
            </tr>
            <tr>
                <td>Moneda</td> <td class="auto-style2"> 
                <asp:DropDownList ID="ddlmoneda" runat="server" Height="18px" Width="318px">
                </asp:DropDownList>
                 </td>
            </tr>
