        ...
        $(function () {
            ...
            $(".btimpr").click(function () {
                ...
                if ($("#MainContent_chkimp").find(":checked").val() == "M") {
                    window.open("../ORDENCOMPRA/REPORTES/OTReporteOrden.aspx?ID=" + idnumordj + "&IDPROC=" + idprovdj + "&DEPRO=" + desprovdj, '_blank');
                } else {
                    window.open("../ORDENCOMPRA/REPORTES/ReporteOrden.aspx?ID=" + idnumordj + "&IDPROC=" + idprovdj + "&DEPRO=" + desprovdj, '_blank');
                }
   ...
   <legend > <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE ORDENES" Font-Bold="True" Font-Size="12pt"></asp:Label></legend>
    ...
    <tr>
        ...
        <td colspan="5">
            ...
            <asp:TextBox ID="txtidpro" Enabled="false" runat="server" Width="102" ></asp:TextBox> 
        </td>
        <td>Fecha De:</td>
        <td>
