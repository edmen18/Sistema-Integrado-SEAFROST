        ...
        $(function () {
            ...
            $(".btgrabar").click(function () {
                ...
                if ($("#MainContent_txtindicador").val() == "G") {
                    ...
                    if (Number($("#MainContent_txtanticipo").val()) == Number($("#MainContent_txttotal").val())) {
                        InsertarLiquidacion();
                        ...
                        alert("No es posible grabar los datos, el detalle no coincide con el monto anticipado");
                ...
                if ($("#MainContent_txtindicador").val() == "A") {
                    ...
                    if ($("#MainContent_txtanticipo").val() == $("#MainContent_txttotal").val()) {
            ...
            $(".btproveedordatos").click(function () { //  se debe colocar dentrp de una funcion 
                ...
                var oc = datosOrdenyProveedor().odencompra;
                var femision = datosOrdenyProveedor().fechaemision;
                var fec = femision;
                ...
                $("#MainContent_txtfechaemision").val(fec);
                ...
                $("#MainContent_lblliquidacion").html(formato);
                    ...
                    alert("La Solicitud no existe o ya está liquidada");
           ...
           function iNSERTAdETALLE() {
            ...
            function actualizarestadoanticipo() {
                var solicitud = {};
                solicitud.ANT_CODIGO = $("#MainContent_txtsolicitud").val();
                solicitud.ESTADO = "L";
               if ($("#MainContent_txtindicador").val() == "G") {
                    $.ajax({
                ...
                if ($("#MainContent_txtindicador").val() == "G") {
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            //alert("Registro Grabado cabecera");
                           },
                        error: function (response) {
                            if (response.length != 0)
                                alert(response);
            ...
            function datosOrdenyProveedor() {
                ...
                if (codigowh != "") {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.d.OC_CCODPRO != "") {
                                ...
                                odencompra = data.d.OC_CNUMORD;
                                var fecemi = moment(data.d.OC_FECEMI).format("DD/MM/YYYY");
                                fechaemision = fecemi;
                    ...
                    return { prov, ruc, odencompra,fechaemision, moneda, montototal, anticipo, porcentaje, pagado, estado};
            ...
            for (var t = 1; t < gridView.rows.length; t++) {
                var inputs = gridView.rows[t].getElementsByTagName('input');
                if (gridView.rows[t].cells[0].innerHTML != $("#MainContent_txtfacturadet").val())
                {
                cellPivot = gridView.rows[t].cells[1];
                subtt = cellPivot.innerHTML;
                sumasub = new Number(sumasub) + new Number(subtt);
            ...
            function AgregarGrilla() {
                ...
                if (numcondicion <= parseFloat($("#MainContent_txtanticipo").val())) {
                    ...
                    alert("No es posible registrar esta cantidad porque sobrepasa al monto establecido como anticipo");

                }
                }
                else {  // en caso de ser edicion
    ...
    <div id="dvdetalle" style="display:none">
        ...
        <table>
            <tr>
             ...
             <tr>
                <td class="auto-style1"> Solicitud Nro.</td> <td>
                    <asp:TextBox ID="txtsolicitud" runat="server" Width="269px"></asp:TextBox> </td>
                 <td>
            ...
            <tr>
             ...
             <tr>
                <td class="auto-style1"> Fecha Regularización</td> <td>
            ...
            <tr>
             ...
             <tr>
                <td class="auto-style1">Total Pagado</td> <td>
                    <asp:TextBox ID="txtmpagar" runat="server" Enabled="False" Width="270px"></asp:TextBox> </td>
            </tr>
            <tr>
                <td>
                    <asp:TextBox ID="txtindicador" runat="server" Width="0px" Enabled="False"></asp:TextBox>
                &nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblcodetalle" runat="server" ForeColor="White" Width="0px"></asp:Label>
                    &nbsp;
                    <asp:TextBox ID="txtaux" runat="server" Width="0px" Enabled="True"></asp:TextBox> 
                </td>
               </tr>
            <tr><td> ****  AGREGAR DETALLE ****</td></tr>
